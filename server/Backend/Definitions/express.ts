...
declare namespace IExpress
{
    ...
    interface Response
    {
        ...
        writeHead(statusCode: number, reasonPhrase?: string, headers?: any): this;
        writeHead(statusCode: number, headers?: any): this;
        end(): void;
        write(data: string): void;
        write(data: any, format: string): void;
    }
    ...
    { 
        /**
             ...
             * third argument.
             */
        (req: Request | IncomingMessage, res: Response | ServerResponse): any;
         ...
         */
        listen(port: number, hostname: string, backlog: number, callback?: (...args: any[]) => void): any;
        listen(port: number, hostname: string, callback?: (...args: any[]) => void): any;
        listen(port: number, callback?: (...args: any[]) => void): any;
        listen(callback?: (...args: any[]) => void): any;
        listen(path: string, callback?: (...args: any[]) => void): any;
